...
class AIService {
  ...
  detectProvider() {
    ...
    throw new Error(
      'No AI API key configured. Please set GEMINI_API_KEY, OPENAI_API_KEY, or ANTHROPIC_API_KEY'
    );
  }
        ...
        messages: [
          {
            role: 'system',
            content:
              'You are a helpful assistant that answers questions with ONLY a single word. No explanations, no additional context.',
          },
          {
            role: 'user',
            content: question,
